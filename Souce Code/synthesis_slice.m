function [gravity_potential,gravity_anomal,gravity_gradient]=synthesis_slice(CNM,SNM,nmax,latmax,latmin,lonmax,lonmin,dlat,dlon,height,nz)
%Layered slicing forward modeling
R=6371000;
GM=3986004.415*1e+8;
